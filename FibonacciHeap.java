...
public class FibonacciHeap {
	...
	/**
	 * 
	 * Return the minimal HeapNode, null if empty. O(1) time complexity as the
	 * function simply returns a property of the Heap.
	 *
	 */
	 ...
	 * 
	 * overall time complexity is the sum of the time complexity of the actual
	 * deletion and the consolidation. the actual deletion does constant work on the
	 * children of min (O(logn) children) and then calls meld. therefore in both
	 * worst case and amortized case it has O(log(n)) time complexity it was shown
	 * during the lecture that the consolidation has O(n) worst case time complexity
	 * and O(log(n)) amortized time complexity.
	 * 
	 * time complexity of deleteMin() is: O(n) worst case O(log(n)) amortized
	 *
	 */
	...
	/**
	 * deleteMin function when called from the method Delete(). implemented without
	 * successive linking
	 * 
	 * @param actualMin: the actual minimum of the heap, as to delete node x, it was
	 *                   made the temporary minimum
	 */
	...
	/**
	 * 
	 * consolidating/successive linking worst time O(n) amortized time complexity
	 * O(log(n))
	 *
	 */
	...
	/**
	 * links two binomial trees of the same rank. returns the node that became the
	 * parent of the other.
	 * 
	 * 
	 ...
	 * @param node2 node with key smaller than node1.key to become another child of
	 *              node1
	 * 
	...
	/**
	 * 
	 * deletes min from roots list time complexity O(1)
	 *
	 */
	 ...
	 * 
	 * time complexity O(1*[num of children node has]), node has O(log(n)) children,
	 * therefore time complexity is O(log(n)) in both worst case and amortized time.
	 *
	 */
	...
	/**
	 * 
	 * Delete the x from the heap. time complexity is the sum of the time complexity
	 * of decreaseKey and deleteMin. therefore: worst case: O(n) amortized: O(logn)
	 *
	 */
